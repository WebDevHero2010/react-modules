    ...
    <div className="main">
      <div className="mainDiv">
        ...
        <p>
          ...
          project and a learning sandbox for you in 💸 and years to come should
          you continue to develope software with React. In this application we
          will work through some of the basic React concepts, build out some
          small applications, and then unleash you to build your own
          applications
        </p>
        <hr />
        ...
        <ul>
          ...
          <li>
            This app simply scratches the surface the surface on what is
            possible with React.
          </li>
          <li>
